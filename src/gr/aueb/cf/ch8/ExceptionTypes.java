...
public class ExceptionTypes {
     ...
     * Since a checked exception is thrown, it has to be explicitly to be thrown in method signature.
     * Or has to be caught{}
     * Wehn this type o method / exception may be used?
     ...
     * If there is a client / used then we do not propagate the exception.
     *
     * @return
     */
    ...
    /**
     * In this type of method / exception, we take action -- logging, and also rethrow the exception to propagate the caller
     * @return
     * @throws IOException
     */
