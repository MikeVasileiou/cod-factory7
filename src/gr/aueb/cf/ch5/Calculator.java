...
/**
 * Δείχνει ένα μενού επιλογών. Ο χρήστης επιλέγει( Πρόσθεση, αφαίρεση κτλπ.)
 * και ανάλογα την επιλογή, εκτελείται η αντίστοιχη πράξη.
 * Εκτυπώνεται το αποτέλεσμα.
 * Εκτελείται επαναληπτικά μέχρι ο χρήστης θα επιλέξει έξοδος
 */
